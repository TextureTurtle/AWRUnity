...
namespace Mono.Data.Tds.Protocol
{
	public class Tds70 : Tds
	{
		...
		public override bool Connect(TdsConnectionParameters connectionParameters)
		{
			...
			{
				num3 = (short)(num3 + (short)((text.Length + connectionParameters.Password.Length) * 2));
			}
			int i = num3;
			...
			num4 = (short)(num4 + (short)(connectionParameters.Hostname.Length * 2));
			if (connectionParameters.DomainLogin)
			{
			...
			else
			{
				...
				num4 = (short)(num4 + (short)(text.Length * 2));
				base.Comm.Append(num4);
				base.Comm.Append((short)connectionParameters.Password.Length);
				num4 = (short)(num4 + (short)(connectionParameters.Password.Length * 2));
			}
			base.Comm.Append(num4);
			base.Comm.Append((short)connectionParameters.ApplicationName.Length);
			num4 = (short)(num4 + (short)(connectionParameters.ApplicationName.Length * 2));
			base.Comm.Append(num4);
			base.Comm.Append((short)base.DataSource.Length);
			num4 = (short)(num4 + (short)(base.DataSource.Length * 2));
			base.Comm.Append(num4);
			base.Comm.Append((short)0);
			base.Comm.Append(num4);
			base.Comm.Append((short)connectionParameters.LibraryName.Length);
			num4 = (short)(num4 + (short)(connectionParameters.LibraryName.Length * 2));
			base.Comm.Append(num4);
			base.Comm.Append((short)base.Language.Length);
			num4 = (short)(num4 + (short)(base.Language.Length * 2));
			base.Comm.Append(num4);
			base.Comm.Append((short)connectionParameters.Database.Length);
			num4 = (short)(num4 + (short)(connectionParameters.Database.Length * 2));
			...
			num4 = (short)(num4 + (short)(connectionParameters.AttachDBFileName.Length * 2));
